...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'phobias_review', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 7, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Review.updated'
        db.add_column(u'phobias_review', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 6, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.created'
        db.delete_column(u'phobias_review', 'created')

        # Deleting field 'Review.updated'
        db.delete_column(u'phobias_review', 'updated')
