...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Artwork.creator'
        db.alter_column(u'phobias_artwork', 'creator', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Artwork.year'
        db.alter_column(u'phobias_artwork', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Artwork.creator'
        raise RuntimeError("Cannot reverse this migration. 'Artwork.creator' and its values cannot be restored.")

        # Changing field 'Artwork.year'
        db.alter_column(u'phobias_artwork', 'year', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'phobias.artwork': {
            ...
            'creator': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'phobias.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marked_as_spam': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
