...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.season'
        db.add_column(u'phobias_review', 'season',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Review.episode'
        db.add_column(u'phobias_review', 'episode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.season'
        db.delete_column(u'phobias_review', 'season')

        # Deleting field 'Review.episode'
        db.delete_column(u'phobias_review', 'episode')
    ...
    models = {
        ...
        u'phobias.review': {
            ...
            'episode': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'season': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
